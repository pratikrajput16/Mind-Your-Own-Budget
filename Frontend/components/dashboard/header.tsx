...
import { Bell, Search, Moon, Sun, Download } from "lucide-react"
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              ...
              <span className="text-sm text-muted-foreground">
                You have used 90% of your Housing budget
              </span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              <span className="font-medium">New Insight Available</span>
              <span className="text-sm text-muted-foreground">
                AI detected a new savings opportunity
              </span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              <span className="font-medium">Weekly Report Ready</span>
              <span className="text-sm text-muted-foreground">
                Your weekly financial summary is available
              </span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
